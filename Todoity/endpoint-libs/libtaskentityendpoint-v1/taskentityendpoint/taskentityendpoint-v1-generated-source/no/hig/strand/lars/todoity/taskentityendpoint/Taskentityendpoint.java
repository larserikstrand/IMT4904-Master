...
public class Taskentityendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetTaskEntity getTaskEntity(java.lang.Long id) throws java.io.IOException {
  ...
  public class GetTaskEntity extends TaskentityendpointRequest<no.hig.strand.lars.todoity.taskentityendpoint.model.TaskEntity> {
     ...
     * @since 1.13
     */
    protected GetTaskEntity(java.lang.Long id) {
    ...
    public GetTaskEntity setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
   ...
   * @return the request
   */
  public RemoveTaskEntity removeTaskEntity(java.lang.Long id) throws java.io.IOException {
  ...
  public class RemoveTaskEntity extends TaskentityendpointRequest<Void> {
     ...
     * @since 1.13
     */
    protected RemoveTaskEntity(java.lang.Long id) {
    ...
    public RemoveTaskEntity setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
