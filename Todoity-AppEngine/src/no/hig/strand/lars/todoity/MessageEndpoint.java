 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "hig.no", ownerName = "hig.no", packagePath="strand.lars.mtp"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBpmEkmjcLZzHf5Qvp5kGmqP6IkhWfvAUo";
